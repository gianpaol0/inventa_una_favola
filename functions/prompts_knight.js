...
const prompts = {
  'start': {
    'prompts': [
      ...
      `Un giorno. Un cavaliere di nome %s che andava alla miniera d'oro di Valmot. La miniera si dicesse che fosse infestata dai fantasmi. Giunto alla miniera, il cavaliere si accorse che c'erano due strade all'interno della miniera. Dove andare? A destra o a sinistra? Aiutalo dicendogli dove andare`,
    ],
    'params': ['name'],
    'suggestions': [
      ['Drago', 'Strega'],
  ...
  'story2_choose1': {
    'prompts': [
      `Il nostro eroe prese la strada di destra e lì scoprì un macchinario che produceva urla di fantasmi. Capì allora che qualcuno per rubare l'oro della miniera aveva finto. Cosa doveva fare %s? Nascondersi ed attendere gli impostori o dirlo al re?`
    ],
    'params': ['name'],
    'suggestions': [
